...
const DepartmentsRedirect: React.FC = () => {
  ...
  useEffect(() => {
    if (!isLoadingCompanies) {
      if (companies.length > 0) {
        // Redirect to the first company's dashboard where they can manage establishments and their departments
...
export default DepartmentsRedirect;