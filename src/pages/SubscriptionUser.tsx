...
const plans = [
  {
    ...
    features: [
      ...
      'User personal visit data for 2 months',
      '50 visitor entries per month',
    ],
...
const SubscriptionUser: React.FC = () => {
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f7f9fb', py: 8 }}>
      ...
      <Typography variant="subtitle1" align="center" gutterBottom>
        Compare our plans and select the one that best fits your needs.
      </Typography>
